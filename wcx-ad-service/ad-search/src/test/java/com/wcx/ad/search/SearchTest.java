...
import com.wcx.ad.search.vo.media.App;
import com.wcx.ad.search.vo.media.Device;
import com.wcx.ad.search.vo.media.Geo;
...
public class SearchTest {
    ...
    public void testFetchAds() {
        ...
        System.out.println("WWWWWWWWWWWWWWWWWWWWWWW"+JSON.toJSONString(request));
        System.out.println("WWWWWWWWWWWWWWWWWWWWWWW"+JSON.toJSONString(search.fetchAds(request)));

    }

    private App buildExampleApp() {
        return new App("wcx", "wcx",
                "com.wcx", "video");
    }
